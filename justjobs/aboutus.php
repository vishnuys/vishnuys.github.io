...
<head>
    ...
    <title>About Us | Just Jobs</title>
    ...
    <div class="container">
        <div class="row">
            <div class="jumbotron">
                ...
                <br>
                <ul>
                    <p>We offer our services for free as we just had the first round of funding, which we are thankful about.</p><br><br>
                    <p>If you like our services and wish to contribute to our small organization, Write to us <a href="contact">here.</a></p>
                </ul>
            </div>
        </div>
        <hr>
